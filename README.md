...
основы → чтение → вопрос дня (закрывает день, а не факт из источника — под
вопросом фиксированное напутствие вернуться к нему в течение дня). Контент —
дневные фиды Азбуки веры.
