...
/// запрошенного дня.
///
/// Прогресс дня отражает сегодняшний контент, а не факт свайпов. Когда сеть
/// недоступна и показан кэш за другую дату, сегодняшних карточек юзер не
/// видел — засчитывать их было бы подлогом, и завтра он увидел бы закрашенные
/// чипсы за день, который не читал. См. [CompleteDay] — там то же правило для
/// серии.
