...
/// Брендинг на время загрузки. Спиннер появляется не сразу: отдача из кэша
/// укладывается в доли секунды, и мигать там индикатором незачем. А вот
/// ожидание сети без него читается как зависший экран — при бюджете загрузки
/// в 10 секунд неподвижный логотип выглядит сломанным приложением.
