...
class TodayStatusChips extends StatelessWidget {
  ...
  /// Перенос `Wrap` при 5 типах кладёт 4 карточки в первую строку и одну
  /// сиротой во вторую — и зависит от масштаба шрифта и экрана, а не только
  /// от количества карточек. Делим сами: первой строке — большая половина.
  @override
